	...
	return (
		<div className='bg-white border border-zinc-300 p-6 rounded-md overflow-x-hidden mb-5'>
			...
			<textarea
				...
				placeholder='Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quae a at sint dolorem perspiciatis nam aut! Ea maiores nulla quam unde blanditiis rem natus fugiat laborum reprehenderit dolorem, repellat porro.'
